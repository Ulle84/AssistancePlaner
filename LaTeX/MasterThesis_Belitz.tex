...
In der zweiten Version des Algorithmus werden die allgemeinen Vorlieben des Klienten berücksichtig. Für jedes Teammitglied kann der Klient eine Priorisierungswert festlegen. %TODO Verlinkung zur Erklärung der Team-Tabelle
...
verändert sich die Punktetabelle. %TODO bessere Begrifflichkeiten finden
Das Ergebnis ist in Tabelle .. zu sehen.

 dann folgendermaßen aus: %TODO Link auf Tabelle
 \begin{table}[htb]
	\centering
\begin{tabular}{|c|c|c|c|}
\hline 
