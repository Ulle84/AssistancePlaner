...
\subsection{PHP}
\label{sec:PHP}
\NewAbb{PHP}{PHP Hypertext Preprocessor} ist eine Programmiersprache, mit der es möglich ist Internetanwendungen zu erstellen. Dabei erzeugt PHP die HTML-Seiten die im Browser angezeigt werden. PHP hat eine sehr gute Datenbank-Unterstützung. Mit PHP kann man objektorientiert programmieren. Ein einfaches PHP-Script ist in Listing \ref{lst:examplePHP} gezeigt.
