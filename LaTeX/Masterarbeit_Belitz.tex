...
%TODO Screenshot einfügen -> overview.png

\begin{figure}[htb]
	\centering
	%\includegraphics[scale=0.2]{../Images/Screenshots/overview.png}
	\includegraphics[scale=0.8]{../Images/Screenshots/overview.png}
	\caption[Overview]{Übersicht Assistenzplaner - von hier aus erreicht man per Link alle Verfügbaren Seiten}
	\label{fig:Overview}
\end{figure}
