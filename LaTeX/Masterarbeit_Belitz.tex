...
Die PHP-Scripte, die für das Speichern zuständig sind, heißen:
\begin{itemize}
\item \file{calendarSaver.php}
\item \file{changePasswordSaver.php}
\item \file{defaultTimesSaver.php}
\item \file{monthPlanSaver.php}
\item \file{rosterSaver.php}
\item \file{settingsSaver.php}
\item \file{toDoSaver.php}
\end{itemize}
