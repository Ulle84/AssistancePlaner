...
%TODO noch mehr zu SysML schreiben
...
Im Netz kann man jede Menge Vorlagen für die Erstellung von Dienstplänen mit Hilfe der Tabellenkalkulation Excel\footnote{http://office.microsoft.com/de-de/excel/ - zuletzt abgerufen am 23.08.2014} finden. Die Zusammenarbeit von Klient und Assistent über das Internet gestaltet sich schwer. Man kann Dokumente freigeben. Damit haben die Assistenten die Möglichkeit ihre Temine einzutragen. Allerdings haben sie damit auch Einsicht und Zugriff auf alles, was sie nicht sehen sollten. Es gibt nicht die Möglichkeit einzelne Bereiche des Dokumentes freizugeben.
...
* QTime  -> zentral/dezentrale Dienstplanerstellung
...
\subsection{Backend}
Beim Backend (der Serverseite) ist die Wahl der Programmiersprache auf PHP gefallen. Hauptgründe hierfür waren: die \href{http://w3techs.com/technologies/history_overview/programming_language}{hohe Verbreitung}\footnote{http://w3techs.com/technologies/history_overview/programming_language - zuletzt abgerufen am 23.08.2014} und die Tatsache, dass PHP bei den meisten Webhostern vorinstalliert ist.

% http://w3techs.com/technologies/history_overview/programming_language
Test: \Link{http://w3techs.com/technologies/history_overview/programming_language}{hohe Verbreitung}{23.08.2014}
%TODO use \footnote{\url{http://en.wikipedia.org/wiki/The_Wisdom_of_Crowds}}
% includee \usepackage{url}
