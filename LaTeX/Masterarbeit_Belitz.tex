...
\subsection{SysML}
\section{Datenbanken} % natürlich nur, wenn verwendet ;-)

\chapter{Anforderungsermittlung}
\section{Begrifflichkeiten}

\subsection{Klient}
Der Klient ist ein körperlich behinderter Mensch, der im alltäglichen Leben auf permanente Hilfe angewiesen ist.
...
\subsection{Team}
Das Team eines Klienten besteht aus mehreren Assistenten. % (während der Entstehung dieser Ausarbeitung aus 7 Stück).

\subsection{Monatsplan}
...
\subsection{Backend}
Beim Backend (der Serverseite) ist die Wahl der Programmiersprache auf PHP gefallen.
