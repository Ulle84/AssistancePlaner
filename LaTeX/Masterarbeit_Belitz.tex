...
\chapter{Test}
Während der Entwicklung hat der Autor permanent getestet. Alle gefunden Bugs wurden sofort beseitigt.
...
\begin{tabular}{|l|l|l|}
\hline 
Gerätekategorie & Betriebssystem & Browser \\ 
\hline 
Laptop & Mac OS & Safari 7.0.3\\ 
\hline 
Laptop & Mac OS & Mozilla Firefox 31.0 \\ 
\hline 
Laptop & Mac OS & Google Chrome 36.0.1985.143 \\ 
\hline
Tablet & iOS & Safari \\ 
\hline
Smartphone & iOS & Safari \\ 
\hline
Desktop & Windows & Mozilla Firefox 31.0 \\ 
\hline

\end{tabular}
\caption{Assistenzplaner wurde auf verschiedenen Gerätekategorien, Betriebssystemen und Browsern erfolgreich getestet}
\label{tab:scoreTableConvertedAndSorted}
\end{table}

Bei keiner der Kombinationen traten Probleme auf.
...
\lstinputlisting[label=lst:exampleJavaScript,caption=Beispiel für ein iCalendar-Termin.]{../iCalendar/example.ics}
...
%TODO überarbeiten
%Überschrit ist unpassend - eigentlich ist die Verwendung von Frameworks nur Mittel zum Zweck sein
* noch mehr Plattformen abdecken durch den Einatz von jQuery
