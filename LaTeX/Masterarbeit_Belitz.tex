...
\subsection{PHP}
\label{sec:PHP}
%TODO Beschreibung PHP -> \cite[S. 16]{theis2006einstieg}
...
\NewAbb{PHP}{PHP Hypertext Preprocessor} ist eine Programmiersprache. Mit ihr lassen sich dynamische Web-Dokumente erzeugen. Mit PHP ist es möglich Internetanwendungen zu programmieren. Meistens erzeugt PHP die HTML-Seiten die im Browser angezeigt werden. PHP hat eine sehr gute Datenbank-Unterstützung. %TODO vorhergehenden Satz überdenken
