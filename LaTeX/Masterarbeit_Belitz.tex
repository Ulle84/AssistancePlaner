...
\addchap{Abstract}
\label{sec:Abstract}
\Note{Hier wird noch die Zusammenfassung auf Englisch ergänzt.}
...
Es ist unter anderem möglich, vergleiche \cite[S.~21]{muenz2012html5},
\begin{itemize}
...
\subsection{PhpStorm}
Als \NewAbb{IDE}{Integrated Development Environment} für die Entwicklung von PHP, HTML, CSS und JavaScript wurde PhpStrom (Version siehe Abbildung \ref{fig:PhpStorm}) verwendet.

\begin{figure}[htb]
	\centering
	\includegraphics[scale=0.5]{../Images/Screenshots/PhpStorm.png}
	\caption{Screenshot des Info-Dialogs der IDE PhpStorm}
	\label{fig:PhpStorm}
\end{figure}
