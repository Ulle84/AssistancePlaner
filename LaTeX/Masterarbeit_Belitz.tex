...
\item Dynamische Manipulation von Webseiten mit Hilfe von DOM %TODO Referenz auf Kapitel %TODO Verlinkung auf Beispiel
\item Senden und Empfangen von Daten, ohne dass der Browser die Seite neu laden muss (AJAX)
\end{itemize}
...
\subsection{DOM}
\Fachbegriff{Document Object Model} \NeuerBegriff{DOM} ist eine Programmierschnittstelle für den Zugriff auf HTML- oder XML-Dokumente. DOM nutzt den baumartigen Aufbau eines Dokumentes und liefert einen Satz von Methoden, der es möglich macht auf Elemente eines Dokuments zuzugreifen und deren Eigenschaften zu verändern. Auch die komplette Umstrukturierung eines Dokuments mittels DOM ist möglich.
...
\subsection{UML}
Die \Fachbegriff{Unified Modeling Language} \NeuerBegriff{UML} \enquote{dient zur Modellierung, Dokumentation, Spezifizierung und Visualisierung komplexer Systeme, unabhängig von deren Fach- und Realisierungsgebiet. Sie liefert die Notationselemente gleichermaßen für die statischen und dynamischen Modelle von Analyse, Design und Architektur und unterstütz insbesondere objektorientere Vorgehensweisen.} \cite[S. 4]{rupp2012uml} 
%TODO ??? verwendete Diagrammtypen beschreiben
%TODO ??? Beispiel-Diagramm 

\subsection{SysML}
\Fachbegriff{System Modeling Language} \NeuerBegriff{SysML} ist eine Sprache die sich zur Modellierung von Systemen einsetzen lässt. Sie basiert auf UML. Die modellierten Systeme könne aus Hard- und Software bestehen.

SysML erweitert UML um einige Diagrammtypen. 
...
Benutzergeschichten haben ein Muster. Nach \cite[S. 59]{wirdemann2011scrum} hat sich für die Beschreibung folgends Muster bewährt:
