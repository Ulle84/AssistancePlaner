...
Akzeptanzkriterien:
\begin{itemize}
\item Es ist möglich jedem Assistenten einen Priorisierungswert zuzuweisen.
\item Der Algorithmus für die Dienstplanerstellung greift auf den Priorisierungswert zu und passt berücksichtigt diesen bei der Dienstplanerstellung.
\end{itemize}
...
\subsection{ToDo}
Als Klient möchte ich Notizen zum Tag erstellen können, die für jeden sichtbar sind (öffentliche Notizen).
...
\subsection{ToDo}
Als Klient möchte ich Notizen zum Tag erstellen können, die nur für mich sichtbar sind (private Notizen).
...
\subsection{ToDo}
Als Klient möchte ich eine Mail an mein Team verschicken können, mit der Bitte freie Termine einzutragen.
...
\subsection{ToDo}
Als Klient möchte ich monatsbezogene Hinweise zum Dienstplan eingeben können.
...
\subsection{ToDo}
Als Assistent möchte ich meine Eingaben im Kalender ändern können.
...
\subsection{ToDo}
Als Assistent möchte ich sehen, wann ich meine Dienste habe.
...
\subsection{ToDo}
Als Assistent möchte ich sehen, wann ich Bereitschaft habe.
...
\subsection{ToDo}
Als Anwender möchte ich mich mit einem eigenen Account beim System anmelden können, um nur die Dinge zu sehen, die mich interessieren und nicht aus Versehen ungewollte Änderungen zu machen.
...
\chapter{Stand der Technik} %TODO alternativ Bestandsanalyse?
...
Wünschenswert wäre es, wenn die Informationen zusätzlich über den gesamten Assistenzplaner an geeigneter Stelle leicht zugänglich verteilt wären. Eine Möglichkeit der Realisierung besteht mit Hilfe von \href{http://jqueryui.com/tooltip/}{jQuery UI Tooltip}\footnote{http://jqueryui.com/tooltip/ - zuletzt abgerufen am 22.08.2014} (siehe Abbildung \ref{fig:jQueryUiTooltip}).
...
* PhpStorm
* Enterprise Architect 11.1 Build 1110 von \href{http://www.sparxsystems.de}{Sparx Systems}\footnote{http://www.sparxsystems.de - zuletzt abgerufen am 22.08.2014}
--> SysML Erweiterung?
* GitHub
