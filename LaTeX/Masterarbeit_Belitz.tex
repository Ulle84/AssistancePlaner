...
* für den Monatsplan wäre es gut

\subsection{ICS Export}

\subsection{Logging}
* wer hat wann was am Assistenzplaner gemacht? inklusive Viewer

\subsection{Responsive Design}
* gute Darstellung auf allen Gerätekategorien (Desktop, Tablet, Smartphone)

\subsection{Team Übersicht überarbeiten}
* Anstelle von Tabelle -> Visitenkarten

\subsection{Inline-Dokumentation}

\subsection{Aufgaben-Manager erweitern}
\subsubsection{Heutigen Tag markieren}
\subsubsection{Ausgewählten Tag markieren}
