...
Mit dem Assistenzplaner hat der Klient die Möglichkeit ihre Assistenz-Teams zu verwalten. Dabei kann der Klient neben den Kontaktdaten auch Priorisierungswerte und Stundenkontigente der Assistenen definieren.
...
%TODO Monatsnavigation fehlt in Anforderungsdiagramm und in Aufzählung
%TODO INput Freddy: Überlegung: Magst Du die Grafik vielleicht in zwei aufteilen? Zunächst eine als Übersicht, die nur die sechs "Haupt-Features" enthält. Und anschließend exemplarisch eine Anforderung detailliert vorstellen? Erstellung Dienst- oder Monatsplan?
...
\begin{figure}[htb]
	...
	\Note{Die Grafik wird durch eine Schönere ausgetauscht! Die Monatsnavigation wird noch als Anforderung ergänzt.}
...
\begin{figure}[H]
%TODO Freddy meinte: ungleiche Größen, ungeleiches RAster, nicht ausgerichtet, etwas lieblos
	\advance\leftskip-2.0cm
	\Note{Grafik wird noch überarbeitet.}
...
%TODO noch mehr zu den Klassendiagrammen schreiben? -> ja, Freddy meinte, ich solle mehr schreiben
...
%TODO Immer einen Abschnitt Ergebnis und einen Abschnitt "Code-Details" schreiben?
...
%TODO schreiben?
..., mit der von einem Monat zum vorherigen, aktuellen und nächsten Monat navigiert werden kann.
...
\chapter{Ergebnis}
%TODO geradeziehen live version und master version
%TODO nach Schreiben der Zusammenfassung diese Passage nochmal überarbeiten
...
%   erstellt.
% ------------------------------------------------------------------------------
%TODO Verweise auf Kapitel am Ende der Literaturangabe unterdrücken
