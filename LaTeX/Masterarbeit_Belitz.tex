...
\section{Verwaltung der Benutzer}
Damit der Klient und die Assistenten benutzerspezifische Eingaben tätigen können ist ein Verwaltung der Benutzer notwendig.
Jeder Benutzer des Assistenzplaners kann sich mit eigener Kennung und Passwort anmelden.
...
\begin{itemize}
\item die Stundenkontigente der Assistenten gleichmäßig ausgeschöpft werden (vgl. Abschnitt ) %TODO Referenz
...
\hline 
\multicolumn{1}{|r|}{Version} & 1 & 2 & 3 & 4 & 5 & 6 \\ 
\hline 
Stichwörter & \xmark & \xmark & \xmark & \xmark & \cmark & \cmark \\ 
\hline 
Stundenkontingent & \xmark & \xmark & \xmark & \cmark & \cmark & \cmark \\ 
\hline 
Priorisierung & \xmark & \cmark & \cmark & \cmark & \cmark & \cmark \\ 
\hline 
Bevorzugte Wochentage & \xmark & \xmark & \cmark & \cmark & \cmark & \cmark \\ 
\hline 
\end{tabular}  
...
In der nächsten Verfeinerung des Algoritmus werden die Stundengkontigente berücksichtigt. Bisher hat der Algorithmus jeden Tag isoliert betrachtet und ein lokales Optimum für jeden Tag gesucht. Um die Stundenkontigente der Assitenten gleichmäßig auzuschöpfen ist es notwendig den gesamten Monat auf einmal zu betrachten. Um dies zu erreichen wird nicht mehr über jeden Tag itereriert. Die Daten werden in ein anderes Tabellenformat konvertiert.
...
* Umwandlung in andere Tabelle
* Randomisierung
* Zusammenrechnen der Dienst- und Bereitschaftsstunden
* Skalierungsfaktor erläutern

\subsection{Fünfte Version - Berücksichtigung der Stichwörter}
\label{sec:algorithmVersion5}
%Erklären warum dieser Aspekt erst so spät einfließt
