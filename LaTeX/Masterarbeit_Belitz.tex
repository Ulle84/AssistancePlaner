...
\item Dynamische Manipulation von Webseiten mit Hilfe von DOM (siehe Abschnitt \label{sec:DOM})
\item Senden und Empfangen von Daten, ohne dass der Browser die Seite neu laden muss mit AJAX (siehe Abschnitt \label{sec:AJAX})
\end{itemize}
...
%DOM nutzt den baumartigen Aufbau eines Dokumentes und liefert einen Satz von Methoden, der es möglich macht auf Elemente eines Dokuments zuzugreifen und deren Eigenschaften zu verändern. Auch die komplette Umstrukturierung eines Dokuments mittels DOM ist möglich.
...
Einige Diagrammtypen aus der UML wurden übernommen und weitere Diagrammtypen hinzugefügt.
