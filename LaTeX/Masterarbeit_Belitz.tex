...
%Neben der PHP-Klassen (siehe Abbildung \ref{UML Klassendiagramm}) wurden einige PHP-Skripte, JavaScript
%TODO entscheiden, ob ich diesen Abschnitt schreibe
...
\Note{Hier kommt evt. noch eine grafische Darstellung des Algorithmus als Ablaufdiagramm hin}
...
Am Algorithmus ließen sich noch ein paar Dinge optimieren, aber nach dem Motto \Link{http://www.clean-code-developer.de/Roter-Grad.ashx}{Vorsicht vor Optimierungen}{29.08.2014} von Clean Code Developer wurde vorerst davon abgesehen.
...
Der Autor plant, das Projekt weiter zu führen und den \LinkWithoutDate{http://assistenzplaner.de}{Assistenzplaner} kontinuierlich zu verbessern und zu erweitern. Die Quellen des Assitenzplaners sind Open-Source und in \LinkWithoutDate{https://github.com/Ulle84/AssistancePlaner}{GitHub} eingecheckt.

\section{Mehr Teams}
\Note{BAUSTELLE: Am 1.9. habe ich den Termin beim Landesbeauftragen für behinderte Menschen in Rheinland Pfalz - sein Feedback und seine Anregungen werde ich hier ggf. einfließen lassen. Weiterhin habe ich hoffenlitch im September ein Gespräch mit dem Leistungsträger von Patrick - hier erhoffe ich mir auch weiteres Feedback}
