...
%Um einen körperlich behinderten Menschen (Klienten) und sein Team (bestehend aus Assistenten) bei der Dienstplanerstellung zu unterstützen wurde die serverbasierte Anwendung geschaffen.
...
Grundlage für die automatische Dienstplanerstellung stellt die Team-Verwaltung dar. Hier kann der Klient seine Assistenten verwalten und Daten eingeben, die bei der Dienstplanerstellung bereücksichtigt werden.

Es wurde ein Algorithmus entwickelt, der alle Vorlieben des Klienten, die Verfügbarkeiten 

* Verfügbarkeiten der Assistenten
* Vorlieben des Klienten
* usw.

* Assistenz-Teams verwalten
* Automatisiert Dienstpläne erstellen
* Aufgaben der Assistenen
* OpenSource
