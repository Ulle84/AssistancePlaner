...
%TODO Monatsnavigation fehlt in Anforderungsdiagramm
...
\item Erstellung Montsplan $\Rightarrow$ MonthOrganisation
\item Team-Verwaltung und Benutzerverwaltung $\Rightarrow$ TeamOrganisation
\item Aufgabenverwaltung $\Rightarrow$ ToDoManager
\end{itemize}
...
%TODO noch mehr zu den Klassendiagrammen schreiben?
...
Die Komponente \texttt{MonthOrganisation} (siehe Abbildung~\ref{fig:UMLComponentMonthOrganisation}) enthält die Klassen \texttt{MonthPlan}, \texttt{AssistanceInput}, \texttt{WorkingTimes} und \texttt{Day}. Zentrale Klasse ist \texttt{MonthPlan}, die Instanzen von allen weiteren Klassen hat.
