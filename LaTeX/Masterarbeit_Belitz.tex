...
Das hier ist die Online-Version der Master-Thesis. Links sind in rot hinterlegt (zum Beispiel \LinkWithoutDate{http://assistenzplaner.de/}{Assistenzplaner}) und können angeklickt werden.
...
\begin{figure}[htb]
	...
	\Note{Dieses Diagramm wird noch überarbeitet.}
...
\subsection{Implementierungsdetails}
Die Einstellungsseite wird von dem PHP-Script \file{settingsView.php}{} generiert. Drückt der Benutzer auf den \button{Einstellungen speichern}, so wird im JavaScript \file{settings.js}{} die Funktion \texttt{saveSettings} aufgerufen. Diese Funktion parst aus den Einstellungen die Daten heraus und schickt sie per \texttt{POST}-Parameter an das PHP-Script \file{settingsSaver.php}{}, welches die Daten im Ordner \folder{Organization} persistent in der Datei \file{settings.txt}{} speichert.
