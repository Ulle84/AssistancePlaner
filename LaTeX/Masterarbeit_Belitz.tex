...
In der vorliegenden Ausarbeitung wird zunächst die Motvation dargestellt. Daraufhin werden nach einem einleitenden Grundlagenteil die Anforderungen dargestellt. Bei einer Marktanalyse wird verifiziert, dass es noch keine bestehende Lösung gibt, die alle Anforderungen erfüllt. Die Kapitel Software-Design und Implementierung zeigen die Umsetzung der Anforderungen. Ein Kapitel widmet sich der Überführung in den Produktiv-Betrieb. Nach einer Betrachtung des Ergebnisses schließt die Arbeit mit einem Fazit ab, in dem einige Verbesserungs- und Erweiterungsmöglichkeiten aufgezeigt werden.
...
%TODO Melanie meinte: umformulieren
