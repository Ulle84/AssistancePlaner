...
\begin{figure}[htb]
	...
	\caption[ToDo]{Screenshot von QTime: Komplexe Software}
...
\begin{figure}[htb]
	...
	\caption[ToDo]{SysML Anforderungsdiagramm}
...
\begin{figure}[htb]
	...
	\Note{Platzhalter}
	\caption[ToDo]{UML Komponentendiagramm}
...
\begin{figure}[htb]
	...
	\caption[ToDo]{UML Klassendiagramm}
...
\begin{figure}[htb]
	...
	\caption[ToDo]{Session-ID wird als Cookie im Browser gespeichert}
...
%TODO sechste Version des Algorithmus
...
\begin{figure}[htb]
	...
	\caption[Todo]{Aufgaben-Verwaltung - Erstellunen einer neuen Aufgabe}
...
Es wurde eine Webanwendung erschaffen, die dem Klienten sehr viel Arbeit abnimmt. Der Klient ist mit der Lösung sehr zufrieden und wird in Zukunft nur noch den Assistenzplaner zur Dienstplanerstellung verwenden.
...
Der Autor plant, das Projekt weiter zu führen und den \Link{http://assistenzplaner.de/PHP/index.php}{Assistenzplaner}{21.09.2014} kontinuierlich zu verbessern und zu erweitern. Die Quellen des Assitenzplaners sind Open-Source und in \Link{https://github.com/Ulle84/AssistancePlaner}{GitHub}{21.09.2014} eingecheckt.
...
\begin{figure}[htb]
	...
	\caption[ToDo]{Schlechte Darstellung des Assistenzplaner auf einem Smart-Phone. Die Eingabefelder sind zu klein und die Display-Größe ist schlecht ausgenutzt.}
...
\begin{figure}[htb]
	...
	\caption[ToDo]{Mögliche neue Darstellungsform eines Assistenten in der Team-Übersicht}
...
\begin{figure}[htb]
	...
	\caption[ToDo]{Sobald der Benutzer in das Feld \enquote{Lastname} klickt, bekommt er einem Hilfstext (Tooltip) angezeigt. Screenshot wurde am 22.08.2014 auf der Webseite http://jqueryui.com/tooltip/ aufgenommen.}
