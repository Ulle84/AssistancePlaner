...
\item Es wird grafisch in 3 Kategorien (grün, gelb, rot) dargestellt, wie gut das Stundenkontigent eines Assistenten ausgeschöpft ist.
\end{itemize}
...
Akzeptanzkriterien:
\begin{itemize}
\item Es gibt einen Algorithmus, der automatisch unter Berücksichtigung der Verfügbarkeiten der Assistenten und der Vorlieben des Klienten einen Dienstplan erstellt, der die Stundenkontigente berücksichtigt.
...
\subsection{Ausschöpfung Stundenkontigent}
Als Assistent möchte ich mein Stundenkontingent möglichst gut ausgeschöpft bekommen.

Akzeptanzkriterien:
\begin{itemize}
\item Der Algorithmus zur Dienstplanerstellung berücksichtigt die Stundenkontigente und erstellt einen Dienstplan, bei dem alle Assistenten ihr Stundenkontigent gleichmäßig ausgeschöpft bekommen.
...
Keiner dieser Anwendungen unterstützt das Bereitschaftskonzept. Einige der Anwendungen sind in der Lage Stundenkontigente zu berücksichtigen. Bei allen Anwendungen wird der Dienstplan manuell erstellt. Bei keiner Anwendung können persönliche Vorlieben oder allgemein Regeln festgelegt werden. Alle Anwendungen waren auf die reine Erstellung eines Dienstplans ausgelegt, Erweiterungen wie Aufgaben-Verwaltung waren nicht vorgesehen.
