...
\begin{figure}[htb]
	\centering
	\fbox{\includegraphics[scale=0.5]{../Images/Screenshots/Mail.png}}
...
\begin{figure}[htb]
	\centering
	\fbox{\includegraphics[scale=0.6]{../Images/Screenshots/CalendarNotesFromClient.png}}
...
Für die Erstellung der SysML, UML und BPMN Diagramme wurde Enterprise Architect in der Version 9.2 verwendet.
