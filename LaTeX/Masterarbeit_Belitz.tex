...
\addchap{Abstract}
\label{sec:Abstract}
%TODO {Abstract auf Englisch schreiben}
...
\Note{Hier kommt noch ein Diagramm hin!}
...
%TODO allemeine Pfeile streichen und dadurch Unabhänige TEile extrahieren
...
In der Datei \file{global.css} sind alle globalen Styles definiert. 
%TODO weitere Stylesheets und deren Einsatzzweck erwähnen
...
\subsection{Implementierungsdetails}
% createNewAccount.php crateNewAccountHandler.php
%TODO hier zwischentext von unten einfügen
...
\Note{Hier werde ich noch eine erläuternde Grafik einfügen.}
...
\subsection{Implementierungsdetails}
%TODO Inhalt produzieren oder Kapitel löschen, falls nicht nötig
